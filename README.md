...
AI Product Manager who codes. I build AI-powered tools and multi-agent systems — from idea to shipped product.

Currently self-employed in Shanghai, exploring the intersection of LLMs, agent frameworks, and real-world business problems.
...
`Python` `TypeScript` `React` `Node.js` `LLM APIs` `Multi-Agent Systems` `Google ADK` `WeChat Ecosystem`
